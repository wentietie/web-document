...
<h2 id="非同源限制" tabindex="-1"><a class="header-anchor" href="#非同源限制" aria-hidden="true">#</a> 非同源限制</h2>
<ul>
<li>无法读取非同源网页的 Cookie、LocalStorage 和 IndexedDB</li>
<li>无法接触非同源网页的 DOM</li>
<li>无法向非同源地址发送 AJAX 请求</li>
</ul>
<h2 id="如何实现跨域请求" tabindex="-1"><a class="header-anchor" href="#如何实现跨域请求" aria-hidden="true">#</a> 如何实现跨域请求</h2>
<h3 id="jsonp" tabindex="-1"><a class="header-anchor" href="#jsonp" aria-hidden="true">#</a> jsonp</h3>
<p>JSONP是JSON with Padding的略称。它是一个非官方的协议，它允许在服务器端集成Script tags返回至客户端，通过javascript callback的形式实现跨域访问（这仅仅是JSONP简单的实现形式）。
利用了 script 不受同源策略的限制，实现了跨域请求</p>
<p>缺点：只能 get 方式，易受到 XSS攻击</p>
<h3 id="cors-cross-origin-resource-sharing-跨域资源共享" tabindex="-1"><a class="header-anchor" href="#cors-cross-origin-resource-sharing-跨域资源共享" aria-hidden="true">#</a> CORS（Cross-Origin Resource Sharing）,跨域资源共享</h3>
...
<h3 id="代理跨域请求" tabindex="-1"><a class="header-anchor" href="#代理跨域请求" aria-hidden="true">#</a> 代理跨域请求</h3>
<p>前端向发送请求，经过代理，请求需要的服务器资源</p>
<p>缺点：需要额外的代理服务器</p>
<h3 id="html5-postmessage-方法" tabindex="-1"><a class="header-anchor" href="#html5-postmessage-方法" aria-hidden="true">#</a> Html5 postMessage 方法</h3>
<p>允许来自不同源的脚本采用异步方式进行有限的通信，可以实现跨文本、多窗口、跨域消息传递</p>
<p>缺点：浏览器版本要求，部分浏览器要配置放开跨域限制</p>
<h3 id="修改-document-domain-跨子域" tabindex="-1"><a class="header-anchor" href="#修改-document-domain-跨子域" aria-hidden="true">#</a> 修改 document.domain 跨子域</h3>
<p>相同主域名下的不同子域名资源，设置 document.domain 为 相同的一级域名</p>
<p>缺点：只能是同一一级域名；相同协议；相同端口</p>
<h3 id="基于-html5-websocket-协议" tabindex="-1"><a class="header-anchor" href="#基于-html5-websocket-协议" aria-hidden="true">#</a> 基于 Html5 websocket 协议</h3>
<p>websocket 是 Html5 一种新的协议，基于该协议可以做到浏览器与服务器全双工通信，允许跨域请求</p>
<p>缺点：浏览器一定版本要求，服务器需要支持 websocket 协议</p>
<h3 id="document-xxx-iframe" tabindex="-1"><a class="header-anchor" href="#document-xxx-iframe" aria-hidden="true">#</a> document.xxx + iframe</h3>
<p>通过 iframe 是浏览器非同源标签，加载内容中转，传到当前页面的属性中</p>
<p>缺点：页面的属性值有大小限制</p>
<h2 id="前端常用代理" tabindex="-1"><a class="header-anchor" href="#前端常用代理" aria-hidden="true">#</a> 前端常用代理</h2>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><h3 id="vite" tabindex="-1"><a class="header-anchor" href="#vite" aria-hidden="true">#</a> vite</h3>

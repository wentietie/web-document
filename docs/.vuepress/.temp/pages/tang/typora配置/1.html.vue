<template><h1 id="_1-自定义主题" tabindex="-1"><a class="header-anchor" href="#_1-自定义主题" aria-hidden="true">#</a> 1.自定义主题</h1>
<p>直接导入<code>pixyll.css</code>即可。</p>
<h2 id="_2-设置字体颜色" tabindex="-1"><a class="header-anchor" href="#_2-设置字体颜色" aria-hidden="true">#</a> 2.设置字体颜色</h2>
<p>打开<code>文件-&gt;偏好设置-&gt;Markdown</code>，勾选<code>内联公式</code>，然后重启Typora后，才可以用内联公式修改文字颜色。</p>
<blockquote>
<p>使用方法</p>
</blockquote>
<div class="language-tex ext-tex line-numbers-mode"><pre v-pre class="language-tex"><code>// 语法
<span class="token equation string">$<span class="token equation-command regex">\textcolor</span>{字体颜色}{文字}$</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>eg：$\textcolor{red}{输入红色字体的例子}$</p>
<blockquote>
<p>颜色公式代码</p>
</blockquote>
<div class="language-tex ext-tex line-numbers-mode"><pre v-pre class="language-tex"><code><span class="token equation string">$<span class="token equation-command regex">\textcolor</span>{GreenYellow}{GreenYellow} $</span>

<template><h1 id="centos7安装gitlab" tabindex="-1"><a class="header-anchor" href="#centos7安装gitlab" aria-hidden="true">#</a> CentOS7安装GitLab</h1>
<p>本教程中，防火墙是关闭的。</p>
...
<p><img src="@source/tang/server/images/CentOS7安装GitLab/sever-install-gitlab-3.png" alt=""></p>

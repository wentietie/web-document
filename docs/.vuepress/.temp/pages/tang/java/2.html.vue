<template><h1 id="spring5源码" tabindex="-1"><a class="header-anchor" href="#spring5源码" aria-hidden="true">#</a> Spring5源码</h1>
<h1 id="_1、spring框架概念" tabindex="-1"><a class="header-anchor" href="#_1、spring框架概念" aria-hidden="true">#</a> 1、Spring框架概念</h1>
...
<p><img src="@source/tang/java/images/Spring5源码/image-20211221170031482.png" alt="image-20211221170031482">
<img src="@source/tang/java/images/Spring5源码/image-20211221174721467.png" alt="image-20211221174721467"></p>
<h3 id="_2-5-2-有参构造注入属性-字符串-基本数据类型" tabindex="-1"><a class="header-anchor" href="#_2-5-2-有参构造注入属性-字符串-基本数据类型" aria-hidden="true">#</a> 2.5.2 有参构造注入属性（字符串/基本数据类型）<img src="@source/tang/java/images/Spring5源码/image-20211221174657603.png" alt="image-20211221174657603"></h3>
<p><img src="@source/tang/java/images/Spring5源码/image-20211221175511923.png" alt="image-20211221175511923"></p>
...
<p>Step1.添加p名称空间</p>
<p><img src="@source/tang/java/images/Spring5源码/image-20211224135021317.png" alt="image-20211224135021317"></p>
<p>Step2.在bean标签中进行属性注入</p>
<p><img src="@source/tang/java/images/Spring5源码/image-20211224135153505.png" alt="image-20211224135153505"></p>
...
<p><img src="@source/tang/java/images/Spring5源码/image-20211224135756396.png" alt="image-20211224135756396"></p>
...
<p><img src="@source/tang/java/images/Spring5源码/image-20211224140113926.png" alt="image-20211224140113926"></p>
...
<p><img src="@source/tang/java/images/Spring5源码/image-20211224141244408.png" alt="image-20211224141244408"></p>
<p>Step2.在xml中配置serviceImpl和daoImpl</p>
<p><img src="@source/tang/java/images/Spring5源码/image-20211224141426703.png" alt="image-20211224141426703"></p>
...
<p>Step1.部门和员工实体类</p>
<p><img src="@source/tang/java/images/Spring5源码/image-20211224153019836.png" alt="image-20211224153019836"></p>
<p>Step2.在xml中配置Emp和Dept</p>
<p><img src="@source/tang/java/images/Spring5源码/image-20211224153337243.png" alt="image-20211224153337243"></p>
<h4 id="_2-5-4-5-级联赋值" tabindex="-1"><a class="header-anchor" href="#_2-5-4-5-级联赋值" aria-hidden="true">#</a> 2.5.4.5 级联赋值</h4>
<p>第一种写法：</p>
<p><img src="@source/tang/java/images/Spring5源码/image-20211224154128121.png" alt="image-20211224154128121"></p>
<p>第二种写法：</p>
<p><img src="@source/tang/java/images/Spring5源码/image-20211224154929289.png" alt="image-20211224154929289"></p>
...
<p><img src="@source/tang/java/images/Spring5源码/image-20211224180449785.png" alt="image-20211224180449785"></p>
<p><img src="@source/tang/java/images/Spring5源码/image-20211224180510812.png" alt="image-20211224180510812"></p>
<p><img src="@source/tang/java/images/Spring5源码/image-20211224180551592.png" alt="image-20211224180551592"></p>
</li>
<li>
<p>FactoryBean：在配置文件（xml文件）中定义的bean类型可以和返回类型不一样</p>
<p><img src="@source/tang/java/images/Spring5源码/image-20211224180434422.png" alt="image-20211224180434422"></p>
<p><img src="@source/tang/java/images/Spring5源码/image-20211224180528426.png" alt="image-20211224180528426"></p>
<p><img src="@source/tang/java/images/Spring5源码/image-20211224180606613.png" alt="image-20211224180606613"></p>
</li>
</ul>
</template>

<template><h1 id="使用prometheus监控kubernetes" tabindex="-1"><a class="header-anchor" href="#使用prometheus监控kubernetes" aria-hidden="true">#</a> <center style="font-size: 38px; font-weight: 900">使用Prometheus监控Kubernetes</center></h1>
<p><span style="color: red">以下操作均是在prometheus名称空间内进行。</span></p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>kubectl create namespace prometheus
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h1 id="_1-部署prometheus" tabindex="-1"><a class="header-anchor" href="#_1-部署prometheus" aria-hidden="true">#</a> 1.部署Prometheus</h1>
<h2 id="_1-1-使用configmap管理prometheus配置" tabindex="-1"><a class="header-anchor" href="#_1-1-使用configmap管理prometheus配置" aria-hidden="true">#</a> 1.1 使用ConfigMap管理Prometheus配置</h2>
<h3 id="_1-1-1创建config-yaml文件" tabindex="-1"><a class="header-anchor" href="#_1-1-1创建config-yaml文件" aria-hidden="true">#</a> 1.1.1创建config.yaml文件</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><h3 id="_1-1-2创建configmap" tabindex="-1"><a class="header-anchor" href="#_1-1-2创建configmap" aria-hidden="true">#</a> 1.1.2创建ConfigMap</h3>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>kubectl apply -f config.yaml
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h2 id="_1-2-使用deployment部署prometheus" tabindex="-1"><a class="header-anchor" href="#_1-2-使用deployment部署prometheus" aria-hidden="true">#</a> 1.2 使用Deployment部署Prometheus</h2>
<h3 id="_1-2-1创建prometheus-deploy-yaml文件" tabindex="-1"><a class="header-anchor" href="#_1-2-1创建prometheus-deploy-yaml文件" aria-hidden="true">#</a> 1.2.1创建prometheus_deploy.yaml文件</h3>
<div class="language-yaml ext-yml line-numbers-mode"><pre v-pre class="language-yaml"><code><span class="token comment"># 创建service</span>
    ...
    <span class="token key atrule">spec</span><span class="token punctuation">:</span>
      ...
      <span class="token punctuation">-</span> <span class="token key atrule">name</span><span class="token punctuation">:</span> prometheus<span class="token punctuation">-</span>config
        <span class="token key atrule">configMap</span><span class="token punctuation">:</span>
          <span class="token key atrule">name</span><span class="token punctuation">:</span> prometheus<span class="token punctuation">-</span>config
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br></div></div><h3 id="_1-2-2-创建prometheus-deployment与service" tabindex="-1"><a class="header-anchor" href="#_1-2-2-创建prometheus-deployment与service" aria-hidden="true">#</a> 1.2.2 创建prometheus Deployment与Service</h3>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>kubectl apply -f prometheus_deploy.yaml
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h2 id="_1-3访问prometheus服务" tabindex="-1"><a class="header-anchor" href="#_1-3访问prometheus服务" aria-hidden="true">#</a> 1.3访问Prometheus服务</h2>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 查看Prometheus服务</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>至此，可以通过http://10.1.93.190:30525/ 查看部署的Prometheus服务。</p>
<p><img src="@source/tang/Prometheus/images/监控kubernetes/1616383973322.png" alt="1_1"></p>
<h1 id="_2-kubernetes下的服务发现" tabindex="-1"><a class="header-anchor" href="#_2-kubernetes下的服务发现" aria-hidden="true">#</a> 2.Kubernetes下的服务发现</h1>
<p>原理：==Prometheus通过与kubernetes API的交互，实现动态发现kubernetes中部署的所有可监控的目标资源。==</p>
<h2 id="_2-1kubernetes访问授权" tabindex="-1"><a class="header-anchor" href="#_2-1kubernetes访问授权" aria-hidden="true">#</a> 2.1kubernetes访问授权</h2>
<p>为了能够让Prometheus能够访问受到认证保护的Kubernetes API，我们需要对Prometheus进行访问授权。授权方法为：<strong>定义ClusterRole并赋予相应访问权限 ---&gt;创建ServiceAccount ---&gt;将ServiceAccount与ClusterRole进行绑定(即创建ClusterRoleBinding)</strong>。可以通过yaml文件完成以上操作。</p>
<h3 id="_2-2-1创建rbac-yaml文件" tabindex="-1"><a class="header-anchor" href="#_2-2-1创建rbac-yaml文件" aria-hidden="true">#</a> 2.2.1创建rbac.yaml文件</h3>
<p><span style="color: red">注意：ClusterRole是全局的，不需要指定namespace；ServiceAccount是属于特定名称空间的，需要指定名称空间(prometheus)。</span></p>
...
<span class="token punctuation">-</span> <span class="token key atrule">kind</span><span class="token punctuation">:</span> ServiceAccount
  <span class="token key atrule">name</span><span class="token punctuation">:</span> prometheus
  <span class="token key atrule">namespace</span><span class="token punctuation">:</span> prometheus
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br></div></div><h3 id="_2-2-2-访问授权" tabindex="-1"><a class="header-anchor" href="#_2-2-2-访问授权" aria-hidden="true">#</a> 2.2.2 访问授权</h3>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>kubectl apply -f rbac.yaml
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h2 id="_2-2使用指定的serviceaccount创建pod" tabindex="-1"><a class="header-anchor" href="#_2-2使用指定的serviceaccount创建pod" aria-hidden="true">#</a> 2.2使用指定的ServiceAccount创建Pod</h2>
<h3 id="_2-2-1修改prometheus-deploy-yaml文件" tabindex="-1"><a class="header-anchor" href="#_2-2-1修改prometheus-deploy-yaml文件" aria-hidden="true">#</a> 2.2.1修改prometheus_deploy.yaml文件</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><h3 id="_2-2-2-升级deployment" tabindex="-1"><a class="header-anchor" href="#_2-2-2-升级deployment" aria-hidden="true">#</a> 2.2.2 升级Deployment</h3>
<div class="language-yaml ext-yml line-numbers-mode"><pre v-pre class="language-yaml"><code>kubectl apply <span class="token punctuation">-</span>f prometheus_deploy.yaml
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h3 id="_2-2-3-查看证书" tabindex="-1"><a class="header-anchor" href="#_2-2-3-查看证书" aria-hidden="true">#</a> 2.2.3 查看证书</h3>
<p>指定ServiceAccount创建的Pod，会自动将用于访问Kubernetes API的CA证书以及当前账户对应的访问令牌文件挂载到Pod实例的 /var/run/secrets/kubernetes.io/serviceaccount/ 目录下：</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 查看pod名字</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><h2 id="_2-3服务发现" tabindex="-1"><a class="header-anchor" href="#_2-3服务发现" aria-hidden="true">#</a> 2.3服务发现</h2>
<p>目前，Prometheus通过Kubernetes API目前主要支持5种服务发现模式，包括<code>Node</code>、<code>Service</code>、<code>Pod</code>、<code>Endpoints</code>、<code>Ingress</code>。</p>
<h3 id="_2-3-1部署node-exporter" tabindex="-1"><a class="header-anchor" href="#_2-3-1部署node-exporter" aria-hidden="true">#</a> 2.3.1部署Node Exporter</h3>
<p>在Prometheus的架构设计中，Prometheus server并不直接服务监控的特定目标，其主要负责数据的收集、存储以及对外提供数据查询支持。因此，为了能够监控到某些东西(如主机的CPU使用率)，我们需要使用Node Exporter。==Prometheus周期性的从Node Exporter暴露的HTTP服务地址(通常是http://IP:port/netrices)拉取监控样本数据。==</p>
<h4 id="_2-3-1-1创建node-exporter-yaml文件" tabindex="-1"><a class="header-anchor" href="#_2-3-1-1创建node-exporter-yaml文件" aria-hidden="true">#</a> 2.3.1.1创建node_exporter.yaml文件</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><h3 id="_2-3-2修改config-yaml文件" tabindex="-1"><a class="header-anchor" href="#_2-3-2修改config-yaml文件" aria-hidden="true">#</a> 2.3.2修改config.yaml文件</h3>
<p>以下通过修改config.yaml文件实现Prometheus对以上5种服务的监控：</p>
<div class="language-yaml ext-yml line-numbers-mode"><pre v-pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> v1
<span class="token key atrule">kind</span><span class="token punctuation">:</span> ConfigMap
<span class="token key atrule">metadata</span><span class="token punctuation">:</span>
  <span class="token key atrule">name</span><span class="token punctuation">:</span> prometheus<span class="token punctuation">-</span>config
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br></div></div><h3 id="_2-3-3更新prometheus" tabindex="-1"><a class="header-anchor" href="#_2-3-3更新prometheus" aria-hidden="true">#</a> 2.3.3更新Prometheus</h3>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 更新Prometheus配置文件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><h3 id="_2-3-4访问prometheus服务" tabindex="-1"><a class="header-anchor" href="#_2-3-4访问prometheus服务" aria-hidden="true">#</a> 2.3.4访问Prometheus服务</h3>
<h4 id="_2-3-4-1-访问service-discovery页面" tabindex="-1"><a class="header-anchor" href="#_2-3-4-1-访问service-discovery页面" aria-hidden="true">#</a> 2.3.4.1 访问Service Discovery页面</h4>
<p>Prometheus更新完成后，访问http://10.1.93.190:30525/，通过<code>Status ---&gt;Service Discovery</code>页面，可以查看到Prometheus监控到Kubernetes的<code>Node</code>、<code>Service</code>、<code>Pod</code>、<code>Endpoints</code>、<code>Ingress</code> 5种资源对象了。</p>
<p><img src="@source/tang/Prometheus/images/监控kubernetes/1616392720399.png" alt="1616392720399"></p>
<h4 id="_2-3-4-2访问targets页面" tabindex="-1"><a class="header-anchor" href="#_2-3-4-2访问targets页面" aria-hidden="true">#</a> 2.3.4.2访问Targets页面</h4>
<p><img src="@source/tang/Prometheus/images/监控kubernetes/1616407155699.png" alt="1616407155699"></p>
<p>附：关于以上红色错误信息，可以后期研究prometheus.yml文件中的<code>relabel_configs</code>编写规则进行改正。</p>
<h1 id="_3-其他参考文档" tabindex="-1"><a class="header-anchor" href="#_3-其他参考文档" aria-hidden="true">#</a> 3.其他参考文档</h1>
<p>k8s 部署prometheus+grafana：https://blog.csdn.net/vic_qxz/article/details/109347645</p>
<p>其中<code>prometheus/config.yaml</code> 文件中的IP需要改成自己的IP。</p>
</template>
